...
uint256 hashGenesisBlock("0x340d5e719c0512c7e09177a783bd8f907a64ecc5872c3e9c1055296e9b30f7ad");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x340d5e719c0512c7e09177a783bd8f907a64ecc5872c3e9c1055296e9b30f7ad");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 19/Sep/2015 U.S. Begins Military Talks With Russia on Syria6";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1442697843;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2262522;
        ...
        assert(block.hashMerkleRoot == uint256("0xa98e7f55f92093ba121123da9b3a86330a22c15b3ff5fcc1c445401950fdcf10"));
